...
export const TRANSLATIONS = {
  zh: {
    ...
    workspace: {
      ...
      downloading: '打包中...',
      publishing: '发布中...',
      publishDialogTitle: '发布到 EdgeOne',
      publishDialogDescription: '正在打包并部署项目，通常需要一两分钟。',
      publishSuccessTitle: '发布成功',
      publishSuccessDescription: '链接有时效，请尽快打开或复制保存。',
      ...
      publishCannotClose: '发布完成前无法关闭',
      publishOpenLast: '打开已发布站点',
      publishDisabledNoProject: '先生成项目后再发布',
      publishDisabledAgentRunning: 'Agent 正在执行，请稍后再发布',
      publishDisabledPublishing: '正在发布…',
      publishStagePackaging: '打包项目',
      publishStageUploading: '上传制品',
      publishStageDeploying: '部署上线',
  ...
  en: {
    ...
    workspace: {
      ...
      publishDialogTitle: 'Publish to EdgeOne',
      publishDialogDescription: 'Packaging and deploying your project. This usually takes a minute or two.',
      publishSuccessTitle: 'Published',
      publishSuccessDescription: 'The link expires. Open or copy it soon.',
      ...
      publishCannotClose: 'Cannot close until publish finishes',
      publishOpenLast: 'Open published site',
