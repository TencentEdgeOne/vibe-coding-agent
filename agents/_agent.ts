...
export function buildSystemPrompt(
  ...
  return [
    ...
    'publish_project deploys the current project to a permanent EdgeOne Makers URL. Call it only when the user explicitly asks to deploy, publish, or go live, and at most once per request. Do not call it after ordinary builds or preview work.',
